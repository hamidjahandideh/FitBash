 ...
 */
public class WorkoutModel extends CalendarBaseModel{
    ...
    public WorkoutModel(int day) {
        super(day);
    }

    public WorkoutModel(int dayNumber, int id, String name, String creator, String goal, String level, String gender, String profilePicture, String musclesInvolved, String totalSet, String totalExercise, String totalTime, String totalCardio, String anatomyPicture, ArrayList<ExerciseModel> exerciseList) {
        super(dayNumber);
        Id = id;
        Name = name;
        Creator = creator;
